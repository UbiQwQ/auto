...
(function(root, factory) {
	...
	*/
	 ...
	 * @return {Number}		  The id (home) of the mock handler suitable for clearing (see $.mockjax.clear())
	 */
	 ...
	 *                                   if a number it is the home in the in-memory cache. If a string or
	...
	/**
	 * Retrive the mock handler with the given id (home).
	 *
	 * @param  {Number} i  The id (home) to retrieve
