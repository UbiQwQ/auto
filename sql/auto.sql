...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户访问记录表';
...
CREATE TABLE `article` (
  ...
  `classification_id` int(11) DEFAULT NULL COMMENT '分类',
  `image` varchar(255) DEFAULT NULL COMMENT '图片',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文章信息表';

-- ----------------------------
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES ('1', '1', '??GSX-250R????300cc??CG???', '2019-01-04 22:37:19', '????????GSX-250R???????250cc??????????????250cc??????????????????????????????????????Ninja250?????????????~', '100', '6', '16759', null, null, '/static/img/j1.7922510.jpg');
...
CREATE TABLE `category` (
  `id` int(11) NOT NULL,
  `category_name` varchar(50) NOT NULL COMMENT '分类 名称',
  `created_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `code` (
  ...
  `value` varchar(25) NOT NULL COMMENT '热门机型',
...
CREATE TABLE `collection` (
  ...
  `created_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='收藏表 文章-用户';
...
CREATE TABLE `comment` (
  ...
  `agree_num` varchar(50) DEFAULT NULL COMMENT '赞同数',
  `disagree_num` varchar(50) DEFAULT NULL COMMENT '反对数',
  `reference_id` int(11) DEFAULT NULL COMMENT '被该评论引用的id',
  `created_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='评论表';
...
CREATE TABLE `country` (
  ...
  `country` varchar(255) DEFAULT NULL COMMENT '国家名',
  `ccode` varchar(255) DEFAULT NULL COMMENT 'countryCode',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `dic` (
  ...
  `partition_id` varchar(50) DEFAULT NULL COMMENT '分区代码',
  `partition_desc` varchar(20) DEFAULT NULL COMMENT '分区描述',
  `dic_code` varchar(30) DEFAULT NULL COMMENT '枚举项代码',
  `dic_label` varchar(50) DEFAULT NULL COMMENT '枚举项名称',
  `del_flg` varchar(2) DEFAULT '1' COMMENT '删除标志：0-删除1-未删除',
...
CREATE TABLE `follow` (
  ...
  `created_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='关注表 用户-用户';
...
CREATE TABLE `manufacturer` (
  ...
  `created_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='厂商表';
...
CREATE TABLE `user` (
  ...
  `password` varchar(20) DEFAULT NULL COMMENT '密码+随机字符串的MD5码',
  `birthday` varchar(50) DEFAULT NULL COMMENT '生日',
  `random_string` varchar(10) DEFAULT NULL COMMENT '随机字符串',
  `gander` varchar(5) DEFAULT NULL COMMENT '性别',
  `phone` varchar(13) DEFAULT NULL COMMENT '电话',
  `email` varchar(25) DEFAULT NULL COMMENT '邮箱',
  `personal_profile` varchar(100) DEFAULT NULL COMMENT '个人介绍',
  `location` varchar(100) DEFAULT NULL COMMENT '所在地',
  `experience` varchar(50) DEFAULT NULL COMMENT '经验值',
  `head` varchar(100) DEFAULT NULL COMMENT '头像',
  `is_admin` int(2) DEFAULT NULL COMMENT '是否是管理员',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户信息表';
